...
const testimonials = [
  {
    ...
    text: 'Bones Fitness a transformé mon parcours de remise en forme. Les entraîneurs sont exceptionnels et l\'atmosphère est motivante !',
    rating: 5,
  },
  {
    name: 'Mike Thompson',
  ...
  },
  {
    ...
    text: 'Les cours collectifs sont tellement amusants ! J\'ai hâte de faire mes entraînements chaque jour grâce à Bones Fitness.',
    rating: 4,
  },
]
